                          ...
                          <li class="header__cart-item">
                              ...
                              <div class="header__cart-item-info">
                                  ...
                                  <div class="header__cart-item-body">
                                      ...
                                      <form action="bosuutap.php" method='post' enctype='multipart/form-data'>
...
<?php
  ...
  $sqlrow= "select bosuutap from sanpham where bosuutap <> '' group by bosuutap";
  $queryloai = mysqli_query($conn, $sqlrow);	
  if (mysqli_num_rows($queryloai) == 0) {
    echo "Chua co du lieu";
  }
  else{
  	
    while($loai = mysqli_fetch_array($queryloai)){
	
    echo "<section class='shop_section layout_padding animate__animated animate__zoomIn'>";
    echo "  <div class='container'>";
    echo "    <div class='heading_container1 heading_center'>";
    echo  "<div class='hieu_ung animate__animated animate__rubberBand'>";
    echo "      <h2 class=''>";
    echo "      $loai[bosuutap]";
    echo "      </h2>";
    echo "    </div>";
    ...
    $sqlchitiet = "select * from sanpham where bosuutap= '$loai[bosuutap]'  group by tensp";
  	$querychitiet = mysqli_query($conn, $sqlchitiet);
	
    while($row = mysqli_fetch_array($querychitiet)){
    echo "      <div class='col-sm-6 col-md-4 col-lg-3 animate__animated animate__zoomIn'>";
    echo "        <div class='box'>";
