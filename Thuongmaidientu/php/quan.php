                          ...
                          <li class="header__cart-item">
                              ...
                              <div class="header__cart-item-info">
                                  ...
                                  <div class="header__cart-item-body">
                                      ...
                                      <form action="quan.php" method='post' enctype='multipart/form-data'>
...
<?php
  ...
  $sqlloai = "select loai from sanpham where masp like 'Q%' group by loai";
  ...
  if (mysqli_num_rows($queryloai) == 0) {
    ...
    $sqlchitiet = "select *,giaca*(1-giamgia) as tongtien from sanpham where loai= '$loai[loai]'  group by tensp";
